...
const taskSchema = new mongoose.Schema({
  ...
  title:       { type: String, required: true },
  description: { type: String },
  // enum élargi : le frontend envoie 'in-progress' (tiret) ; on tolère aussi 'in_progress'
  status:      { type: String, enum: ['todo', 'in-progress', 'in_progress', 'done'], default: 'todo' },
  priority:    { type: String, enum: ['low', 'medium', 'high'], default: 'medium' },
  assignedTo:  { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
  dueDate:     Date,
  // Planning / Gantt (envoyés par le frontend)
  startDate:   Date,
  endDate:     Date,
...
const financeSchema = new mongoose.Schema({
  ...
  notes:                   { type: String },
  // Transactions simples (recette / dépense) envoyées par le frontend
