                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        const doc = await Document.findById(req.params.id);
                                                                                                                                                                                                                            if (!doc) return res.status(404).json({ error: 'Not found' });
                                                                                                                                                                                                                                const { users, role } = req.body;
                                                                                                                                                                                                                                    const toAdd = Array.isArray(users) ? users : [users];
                                                                                                                                                                                                                                        toAdd.forEach(userId => {
                                                                                                                                                                                                                                              const exists = doc.intervenants.find(i => i.user.toString() === userId.toString());
                                                                                                                                                                                                                                                    if (!exists) {
                                                                                                                                                                                                                                                            doc.intervenants.push({ user: userId, role: role || 'validator', decision: 'pending' });
                                                                                                                                                                                                                                                                  }
                                                                                                                                                                                                                                                                      });
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      if (!['approved', 'rejected'].includes(decision)) {
                                                                                                                                                                                                                                                                                                            return res.status(400).json({ error: 'decision must be approved or rejected' });
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    const doc = await Document.findById(req.params.id);
                                                                                                                                                                                                                                                                                                                        if (!doc) return res.status(404).json({ error: 'Not found' });
                                                                                                                                                                                                                                                                                                                            const intervenant = doc.intervenants.find(i => i.user.toString() === req.userId.toString());
                                                                                                                                                                                                                                                                                                                                if (!intervenant) return res.status(403).json({ error: 'Not a validator for this document' });
                                                                                                                                                                                                                                                                                                                                    intervenant.decision = decision;
                                                                                                                                                                                                                                                                                                                                        intervenant.comment = comment || '';
                                                                                                                                                                                                                                                                                                                                            intervenant.validatedAt = new Date();
                                                                                                                                                                                                                                                                                                                                                updateGlobalStatut(doc);
                                                                                                                                                                                                                                                                                                                                                    doc.updatedAt = new Date();
                                                                                                                                                                                                                                                                                                                                                        await doc.save();
                                                                                                                                                                                                                                                                                                                                                            await doc.populate('intervenants.user', 'name email');
                                                                                                                                                                                                                                                                                                                                                                res.json(doc);
